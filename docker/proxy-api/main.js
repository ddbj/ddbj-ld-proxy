...
fastify.get('/dev/genome/search',  {
  description: 'Perform a REST-style search of the genome index using query parameters',
  schema: {
    summary: 'Perform a REST-style search of the genome index using query parameters',
    querystring: {
      type: 'object',
      properties: {
        sort: {
